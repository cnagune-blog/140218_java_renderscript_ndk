...
/**
 * @brief Grayscale 변환 함수 - 일반 명령어 사용, bitmap 직접 제어
 *
 * @param env ...
 * @param thiz ...
 * @param in_bitmap 계산되고자 하는 bitmap 원본
 * @param out_bitmap 계산 결과를 저장할 bitmap
 */
    ...
    (JNIEnv *env, jobject thiz, jobject in_bitmap, jobject out_bitmap)
{
    ...
    // 5. 변환 작업 수행
    argb8888_to_gray(in_pixels, out_pixels, in_info.width * in_info.height);
...
/**
 * @brief Grayscale 변환 함수 - NEON 명령어 사용, bitmap 직접 제어
 *
 * @param env ...
 * @param thiz ...
 * @param in_bitmap 계산되고자 하는 bitmap 원본
    ...
    (JNIEnv *env, jobject thiz, jobject in_bitmap, jobject out_bitmap)
{
    ...
    // 5. 변환 작업 수행
    argb8888_to_gray_neon(in_pixels, out_pixels, in_info.width * in_info.height);
...
/**
 * @brief Grayscale 변환 함수 - 일반 명령어와 Thread 사용, bitmap 직접 제어
 *
 * @param env ...
 * @param thiz ...
 * @param in_bitmap 계산되고자 하는 bitmap 원본
    ...
    (JNIEnv *env, jobject thiz, jobject in_bitmap, jobject out_bitmap, jint thread_cnt)
{
    ...
    // 5. 변환 작업 수행
    argb8888_to_gray_thread(in_pixels, out_pixels, in_info.width * in_info.height, thread_cnt);
    ...
    (JNIEnv *env, jobject thiz, jobject in_bitmap, jobject out_bitmap, jint thread_cnt)
{
    ...
    // 5. 변환 작업 수행
    argb8888_to_gray_neon_thread(in_pixels, out_pixels, in_info.width * in_info.height, thread_cnt);
